...
public class Inventory extends JFrame implements ActionListener {
  ...
  Inventory() {
    ...
    // "select t.BillID,c.Price,c.Quantity, b.BillDate, b.PaymentMethod from
    // Transactions t join Checkout c on t.BillID = c.BillID join bills b on
    // t.BillID = b.BillID where t.CustomerID = 4;");
  ...
  public static void main(String[] args) {
    new Inventory(); // calling the object
  }
}
